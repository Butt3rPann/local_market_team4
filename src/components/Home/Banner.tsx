...
import { BsChevronCompactLeft, BsChevronCompactRight } from "react-icons/bs";
 ...
 function Banner() {
   ...
   return (
     <>
       <div className="flex justify-center items-center px-2 overflow-hidden w-screen relative group">
         <div
           style={{ backgroundImage: `url(${slideImages[currentIndex].url})` }}
           className="w-full h-[31vw] rounded-2xl bg-cover bg-center duration-500"
         ></div>
         <div
